...
export default function PlayerPromptHeader({ gameName, roundLabel, prompt }) {
  return (
    <>
      {gameName ? (
      ...
      <div className="w-full max-w-lg bg-[#1A1A2E] border-2 border-[#4ECDC4] rounded-2xl p-6 mb-6 text-center">
        <p className="text-xs font-['Nunito'] text-[#4ECDC4] uppercase tracking-widest mb-2">Who is most likely to...</p>
